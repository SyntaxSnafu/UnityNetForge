...
namespace UnityNetForge.Networking
{
    public class PausedSocketFix
    {
        private readonly UnityNetForge.UnityNetForgeManager _netManager;
        ...
        public PausedSocketFix(UnityNetForge.UnityNetForgeManager netManager, IPAddress ipv4, IPAddress ipv6, int port, bool manualMode)
        {
