...
[assembly: InternalsVisibleTo("UnityNetForge.Tests")]

namespace UnityNetForge
{
    /// <summary>
    ///     This class represents the entry-point to UnityNetForge Networking communications.
    ...
    public partial class UnityNetForgeManager
    {
        ...
        /// <summary>
        ///     Creates a new <see cref="UnityNetForgeManager" />.
        /// </summary>
        ...
        ///     All <see cref="UnityNetForgeManager" /> instances connected together must have the same configured layers.
        /// </param>
        public UnityNetForgeManager(PacketLayerBase? extraPacketLayer = null)
        {
        ...
        /// <returns>The UnityNetForgePeer, if connection was successful. Returns null if we are waiting for a response.</returns>
